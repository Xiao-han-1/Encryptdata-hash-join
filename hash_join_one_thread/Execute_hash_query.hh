...
public:
    ...
    vector<vector<string>> Hash_join(vector<pair<string, string>> h_table,pg* con);
    unordered_map<int,vector<string>>  get_Aes_val(string table,pg* con);
