...
public:
    ...
    double handle_multi_thread(string  query,string scale,double &AVG_Decrypt_time);
    ...
    vector<vector<string>> Hash_join(vector<pair<string, string>> h_table,string query,vector<pair<string, string> > tab,string scale);
