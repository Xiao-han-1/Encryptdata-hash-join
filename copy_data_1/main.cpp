...
void Aes_Mapping_name(Table* table,vector<Enc_Table*> Aes_Table)
{
  ...
  std::ofstream outfile("data/sharding/0.1gb/aes_table_name_map_0.1_1_1.txt", std::ios::app);
    if (!outfile.is_open()) {
...
int main()
{
    ...
    // std::ofstream outfile("data/sharding/0.1gb/aes_table_name_map_0.1_1_10.txt", std::ios::app);
